...
- **Thesis-killer #2 — Financing-vehicle circularity *and* Broadcom's own contingent exposure to it.** *(Reframed 2026-09-02. The prior framing — "exogenous (system-level, not AVGO-balance-sheet) risk … AVGO's own ND/EBITDA is a comfortable 1.08×" — was wrong in a specific way: it treated the vehicle's leverage as the whole of the risk and Broadcom's balance sheet as uninvolved. Broadcom guarantees part of it.)*
  ...
  - **⚠️ PARTIALLY RESOLVED (2026-09-09, via WebSearch — direct sec.gov read still blocked, so treat as secondary-sourced pending a primary confirm).** The Q3 FY26 10-Q (`avgo-20260802.htm`) has been filed and does contain formal contingent-liability language on the RVGs ("contingent liabilities [Broadcom] believe[s] would have a low probability of occurring...") — the accounting-treatment side of the two open questions is answered: yes, it is disclosed as a filed contingency, not left as a verbal-only characterization. On the size question: asked directly about incremental exposure on the 9/2 call, management said there is "nothing new to add" beyond the existing ~$29B max on the initial $35B tranche — no escalation, and the separate $60-100B second package remains unsigned. **Rating implication left to the collaborative process (rule 2/8) — this note is research, not a rating change.** Full footnote text still unread directly; a primary read of `avgo-20260802.htm` would confirm nothing beyond this WebSearch summary is being missed.
