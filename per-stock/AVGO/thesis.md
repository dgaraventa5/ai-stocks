...
**Last reviewed:** 2026-06-17 *(populated from the post-Q2-FY26 briefing `context-2026-06-12.md`; objective inputs refreshed 2026-06-12)*
...
Six core AI customers, now structured around gigawatt-scale, multi-year commitments rather than one-off design wins (earnings call 2026-06-03; 8-K 2026-04-06):

| Customer | Commitment | Source / date |
|---|---|---|
| Google | Multi-generation TPU dev + supply + networking Supply Assurance through up to **2031** | 8-K 2026-04-06 (Item 8.01) |
| Anthropic | >1 GW TPU compute in 2026; expansion from 2027 (~3.5 GW per 8-K; "another 5 GW" per call — **unreconciled, flagged**) | 8-K 2026-04-06; call 2026-06-03 |
| OpenAI | Silicon delivered, production late 2026; **1.3 GW contractual in 2027** within 10 GW-by-2029 deal | call 2026-06-03 (deal Oct 2025) |
| Meta | Multi-gen MTIA XPUs, **3 GW through end-2028**; initial 1 GW order placed, deliveries 2H 2027 | call 2026-06-03 |
| Two unnamed | Shipments begin late 2026; **$6B in POs to date** | call 2026-06-03 |

- **Hyperscaler exposure:** AI revenue is effectively all hyperscaler/frontier-lab demand. Q2 AI **bookings exceeded $30B** vs. $10.8B shipped; visibility extended from 2027 to 2028 in a single quarter (call 2026-06-03).
- **Concentration risk:** High. Six customers are essentially the entire AI franchise, and two of them (Anthropic, OpenAI) are pre-profit frontier labs whose consumption is "dependent on … continued commercial success" (8-K 2026-04-06 language). Scored **Cust Conc 3** (watchlist 2026-06-12).
- **Substitution risk:** The whole point of the XPU business *is* customer in-housing of compute — AVGO captures the design rather than losing it. The residual risk is dual-sourcing: Tan acknowledged on the Q2 call, for the first time, that Google will have "some diversity of sources" (call 2026-06-03). Watch for Marvell or internal teams taking share at the anchor accounts.
...
- **Scale advantage:** Largest merchant XPU designer; co-development across six frontier customers compounds design IP and packaging learning.
- **Switching costs:** Very high. XPU programs are multi-generation co-engineering relationships; the Google agreement runs through up to 2031 (8-K 2026-04-06). Re-architecting a custom accelerator to a new vendor is a multi-year reset.
...
**Moat rating:** Wide — but with a live erosion vector (anchor-customer dual-sourcing, first acknowledged Q2 2026) to monitor.
...
- **Thesis-killer #1 — Core-customer loss / in-housing:** Google or Meta moving XPU volume to a rival merchant designer or fully internal team. Google dual-sourcing was acknowledged for the first time on the Q2 call (2026-06-03) — currently "diversity of sources," not a loss, but the vector is now live.
- **Thesis-killer #2 — Financing-vehicle circularity:** The new >20 GW Apollo/Blackstone-funded XPU platform ($35B first tranche) decouples capacity from customer balance sheets. Bull read: removes the binding constraint on demand. Bear read: AVGO's flavor of circular AI financing — if token-demand growth disappoints, the vehicle's committed capacity becomes the overhang. 8-K (2026-04-06) language ties Anthropic consumption to its "continued commercial success." This is a new, exogenous (system-level, not AVGO-balance-sheet) risk — AVGO's own ND/EBITDA is a comfortable 1.08× (watchlist 2026-06-12).
...
- **Cyclical risk:** A hyperscaler capex pause would hit XPU and networking hard; AI is now ~49% of revenue, so the franchise is increasingly levered to one spend cycle.
...
- **Margin:** GM mix dilution is now guided (77.1% → ~74% Q3), not hypothetical — XPUs carry lower margin than legacy semis and software.
- **Execution / management:** Possible CFO/IR transition signals on the Q2 call (analysts welcoming "Kirsten and Amie") — **no Item 5.02 8-K confirmed as of 2026-06-12; verify before treating as fact.**
