...
## Layer 01 — 33 names
metrics: ev_ebitda=pct(32)  fcf_yield=pct(33)  ps=pct(31)  roic=pct(33)  gm=pct(33)  fcf_mgn=pct(31)
...
## Layer 04 — 28 names
metrics: ev_ebitda=pct(27)  fcf_yield=pct(27)  ps=pct(27)  roic=pct(27)  gm=pct(28)  fcf_mgn=pct(27)
...
## Layer 06 — 22 names
metrics: ev_ebitda=pct(22)  fcf_yield=pct(22)  ps=pct(22)  roic=pct(21)  gm=pct(22)  fcf_mgn=pct(22)
members: ADI, ALAB, ALGM, AMBA, AMD, AVGO, LSCC, MCHP, MELE.BR, MPWR, MRVL, MU, NVDA, NVTS, NXPI, ON, QCOM, RMBS, SNDK, STM, SWKS, TXN

## Layer 07 — 12 names
metrics: ev_ebitda=pct(12)  fcf_yield=pct(12)  ps=pct(12)  roic=pct(12)  gm=pct(12)  fcf_mgn=pct(12)
members: AAOI, ANET, APH, CIEN, COHR, CRDO, CSCO, FN, GLW, LITE, POET, TEL

## Layer 08 — 8 names
metrics: ev_ebitda=pct(8)  fcf_yield=pct(8)  ps=pct(8)  roic=pct(8)  gm=pct(8)  fcf_mgn=pct(8)
members: DELL, FLEX, HPE, NTAP, P, SMCI, STX, WDC

## Layer 09 — 20 names
metrics: ev_ebitda=abs(20)  fcf_yield=pct(20)  ps=pct(20)  roic=pct(20)  gm=pct(20)  fcf_mgn=pct(20)
members: AMZN, APLD, BTDR, CIFR, CLSK, CORZ, CRWV, GOOGL, HIVE, HUT, IREN, KEEL, META, MSFT, NBIS, ORCL, RIOT, SHAZ, WULF, WYFI

## Layer 10 — 22 names
metrics: ev_ebitda=pct(21)  fcf_yield=pct(22)  ps=pct(22)  roic=pct(22)  gm=pct(22)  fcf_mgn=pct(22)
members: AAPL, ADBE, ADSK, APP, CRM, CRWD, DDOG, FTNT, HOOD, INTU, MDB, NOW, PANW, PATH, PLTR, RDDT, SNOW, SPCX, TEM, TSLA, WDAY, ZS

## Layer 11 — 39 names
metrics: ev_ebitda=pct(33)  fcf_yield=pct(33)  ps=pct(39)  roic=pct(23)  gm=pct(39)  fcf_mgn=pct(33)
